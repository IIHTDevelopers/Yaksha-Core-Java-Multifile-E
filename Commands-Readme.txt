* Command to run code for use-case 1:
	mvn compile exec:java -Dexec.mainClass="com.iiht.training.negativefirst.ArrayNegativeBeforePositive"

* Command to run code for use-case 2:
	mvn compile exec:java -Dexec.mainClass="com.iiht.training.reflections.StringAlphabetReflection"
